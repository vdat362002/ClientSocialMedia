      ...
      {isLaptop ? (
        <nav className="contain flex justify-between items-center z-9999 border-b border-transparent dark:border-gray-900 align-center w-100 bg-white text-gray-700 h-60px py-2 fixed w-full shadow-md laptop:shadow-sm dark:bg-indigo-1000">
          ...
          <div className="flex items-center space-x-16">
            <NavLink className="flex items-center justify-center w-12 h-12 cursor-pointer rounded-full hover:bg-gray-200 dark:hover:bg-indigo-1100" title="Home" to="/">
              <HomeOutlined />
            </NavLink>
            <NavLink className="flex items-center justify-center w-12 h-12 cursor-pointer rounded-full hover:bg-gray-200 dark:hover:bg-indigo-1100" title="Watch" to="/watch">
              <VideoCameraOutlined />
            </NavLink>
          </div>
