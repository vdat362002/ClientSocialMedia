                                            ...
                                            <div className="flex items-start">
                                                ...
                                                <div>
                                                    <span className="text-indigo-700 dark:text-indigo-400 font-medium break-all">
                                                        {(notif.initiator?.firstname && notif.initiator?.lastname) ? `${notif.initiator?.firstname} ${notif.initiator?.lastname}` : notif.initiator?.username}
                                                    </span>
                                                    &nbsp;
                                                    <span className="text-gray-600 dark:text-gray-400 break-all">
                                                        {
                                                            notif.type === 'like' && notif.react === "Like" ? 'likes your post.' :
                                                                notif.type === 'like' && notif.react === "Heart" ? 'love your post.' :
                                                                    notif.type === 'like' && notif.react === "Haha" ? 'haha your post.' :
                                                                        notif.type === 'like' && notif.react === "Wow" ? 'wow your post.' :
                                                                            notif.type === 'like' && notif.react === "Sad" ? 'sad your post.' :
                                                                                notif.type === 'like' && notif.react === "Angry" ? 'angry your post.'
