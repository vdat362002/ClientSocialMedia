...
const Messages = ({ isAuth }) => {
    ...
    const updateNewMessages = (prevMessages, newMessage) => {
    ...
    const handleClickOutside = (e) => {
        ...
        const wrapper = (e.target).closest('.messages-wrapper');
        const seeMoreButton = (e.target).closest('.see-more-button');
    ...
    const handleReadMessage = async (sender) => {
        try {
