                    ...
                    <div className="relative flex items-center justify-between px-4 py-2">
                        <Link to={`/user/${user.username}`}>
                            <div className="flex items-center">
                                ...
                                <h6 className="mr-10 text-sm overflow-ellipsis overflow-hidden dark:text-white">{(user?.firstname && user?.lastname) ? `${user.firstname} ${user.lastname}` : user.username}</h6>
                            </div>
                        </Link>
